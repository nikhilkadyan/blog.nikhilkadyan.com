		...
		<Layout>
			<div className='lg:max-w-3xl'>
				...
				<p className='mt-8 font-thin'>
					<span className='font-bold'>BASIC ('beɪ.sɪk'; Adj)</span>: lover of all things mainstream, popular, & trending in the world of .
				</p>
				<p className='mt-8 font-thin'>
					Ever since I used my first iPhone to click those stunning pictures & being able to run just about everything with max performance, I've had an incredible affinity for Apple - from the iMac to their iPod socks. Their products gave a then young me tools that pushed the boundaries of what I felt capable of and provided me with a creative reach that I didn't know was possible.
				</p>
				<p className='mt-8 font-thin'>
